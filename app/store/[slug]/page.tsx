...
import { Phone, MapPin, Package, Search, X, ChevronLeft, ChevronRight, Star, Heart, ShoppingCart, Filter, Facebook, Instagram, Twitter, Mail } from "lucide-react"
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="relative">
                ...
                {/* Store Info Card */}
                <div className="max-w-7xl mx-auto px-4 relative -mt-20 mb-12">
                    <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 border border-slate-200">
                        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 mb-5 max-w-2xl text-base">
                                    {profile.storefront_description}
                                </p>
                                <div className="flex flex-col sm:flex-row gap-5 text-sm text-slate-700">
                                    <a href={`tel:${profile.phone_number}`} className="flex items-center gap-3 hover:text-emerald-600 transition font-medium">
                            ...
                            <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl p-6 text-center text-white shadow-lg">
                                <p className="text-xs font-semibold uppercase tracking-wide mb-2 opacity-90">Total Products</p>
            ...
            {/* ===== FOOTER ===== */}
            <footer className="bg-slate-900 text-white border-t-2 border-emerald-600 mt-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2 text-slate-300 text-sm">
                                <li><a href="#" className="hover:text-emerald-400 transition">New Products</a></li>
                                <li><a href="#" className="hover:text-emerald-400 transition">Best Sellers</a></li>
                                <li><a href="#" className="hover:text-emerald-400 transition">Wishlist</a></li>
                                <li><a href="#" className="hover:text-emerald-400 transition">Browse All</a></li>
                            </ul>
                        </div>
